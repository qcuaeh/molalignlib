...
subroutine super(label0, label1, mol0, mol1)
...
!    call readmol('xyz', natom1, title1, label1, mol1, nbond1, bonds1, znum1)
    ...
    allocate(bonds0(2, maxcoord*natom0), bonds1(2, maxcoord*natom1))

    do i = 1, natom0
        call readlabel(label0(i), znum0(i))
        call readlabel(label1(i), znum1(i))
    end do

    ! Get adjacency matrices and lists

!    call getadjacency(natom0, mol0, adjrad(znum0), adjmat0, ncoord0, adjlist0, nbond0, bonds0)
!    call getadjacency(natom1, mol1, adjrad(znum1), adjmat1, ncoord1, adjlist1, nbond1, bonds1)
    ...
    ! Group atoms by NMA at infinite lavel

!    call groupmnaequiv(natom0, nblock0, blocktype0, ncoord0, adjlist0, nequiv0, equivsize0, &
!        equivtype0)
!    call groupmnaequiv(natom1, nblock1, blocktype1, ncoord1, adjlist1, nequiv1, equivsize1, &
!        equivtype1)
    ...
    equivtype0 = equivtype0(order0)
    equivtype1 = equivtype1(order1)
    ...
    adjmat0 = adjmat0(order0, order0)
    adjmat1 = adjmat1(order1, order1)

    ncoord0 = ncoord0(order0)
    ncoord1 = ncoord1(order1)

    adjlist0 = adjlist0(:, order0)
    adjlist1 = adjlist1(:, order1)

    order0 = inversemap(order0)
    order1 = inversemap(order1)

    do i = 1, natom0
        adjlist0(:ncoord0(i), i) = order0(adjlist0(:ncoord0(i), i))
    end do

    do i = 1, natom1
        adjlist1(:ncoord1(i), i) = order1(adjlist1(:ncoord1(i), i))
    end do

    do i = 1, nbond0
        bonds0(:, i) = order0(bonds0(:, i))
    end do

    do i = 1, nbond1
        bonds1(:, i) = order1(bonds1(:, i))
    end do
...
!    call groupadjlist(natom0, equivtype0, ncoord0, adjlist0, nadjeq0, adjeqsize0)
!    call groupadjlist(natom1, equivtype1, ncoord1, adjlist1, nadjeq1, adjeqsize1)
