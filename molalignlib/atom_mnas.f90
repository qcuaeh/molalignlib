...
public compute_consistent_mnas
...
function eltypetree(atoms1, atoms2) result(chain_root)
...
subroutine compute_nextlevel_mnas(atoms1, atoms2, mnachain, num_splits)
...
subroutine compute_consistent_mnas(atoms1, atoms2, atomtypes, mnachain)
...
!   mnachain => eltypetree( atoms1, atoms2)
