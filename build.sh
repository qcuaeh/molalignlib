...
if $test_flag; then
   # Run tests
   run_tests fast17 jcim.2c01187/0.05 -remap -prune -tol 0.17
   run_tests fastbond MOBH35-shuffled -remap -bond
   run_tests fastbondback MOBH35-shuffled -remap -bond -back
