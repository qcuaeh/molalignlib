...
program molalign
   ...
   logical :: reorder_flag, mirror_flag, stdin_flag, stdout_flag
...
!         call readoptarg(arg, bias_scale)
   ...
   if (reorder_flag) then
      ...
      do i = 1, nrec
         ...
         if (.not. stats_flag) write (output_unit, '(a)') realstr(rmsd, 4)

         call writefile(write_unit, fmtout, 'Map='//intstr(i)//' RMSD='//realstr(rmsd, 4), natom1, &
