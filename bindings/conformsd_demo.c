 ...
 *
 * Compile:
 *   gcc conformsd_demo.c -o demo_conformsd -lm -lgfortran -lmolalign
 *
 ...
 *
 *   gcc conformsd_demo.c -o demo_conformsd \
 *       -I$HOME/.local/include/molalignlib -L$HOME/.local/lib \
 *       -lm -lgfortran -lmolalign
 *
 * Run:
 *   ./demo_conformsd conf1.xyz conf2.xyz -align -remap -bond 0.4
 *
